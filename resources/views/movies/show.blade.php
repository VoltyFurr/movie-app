...
@section('content')
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <div class="flex-none">
                <img src="{{ $movie['poster_path'] }}" alt="" class="w-64 lg:w-96 rounded-lg">
            </div>
            <div class="md:ml-24">
                <h2 class="text-4xl font-semibold text-lime-500">{{ $movie['title'] }}</h2>
                <div class="flex flex-wrap items-center text-gray-400 text-sm">
                    <svg class="fill-current text-lime-500 w-4" viewBox="0 0 24 24">
                        <g data-name="Layer 2">
                ...
                <div class="mt-8">
                    <h4 class="text-white font-semibold text-lime-500">Featured cast</h4>
                    <div class="flex mt-6">
                    ...
                    @if (count($movie['videos']['results']) > 0)
                        <div class="mt-12">
                            <button @click="isOpen = true"
                                    class="flex inline-flex items-center bg-lime-500 text-gray-900 rounded font-semibold px-5 py-4 hover:bg-lime-700 transition ease-in-out duration-150">
    ...
    <div class="movie-cast border-b border-gray-800">
        <div class="container mx-auto px-4 py-16">
            <h2 class="text-4xl font-semibold text-lime-500">Cast</h2>
    ...
    <div class="movie-images" x-data="{ isOpen: false, image: ''}">
        <div class="container mx-auto px-4 py-16">
            <h2 class="text-4xl font-semibold text-lime-500">Images</h2>
